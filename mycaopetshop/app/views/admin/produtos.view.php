...
<body>
    ...
    <div class="container">
      ...
      <nav class="navbar navbar-light bg-light nav-search">
        <div class="container-fluid bottom-add d-flex">
          ...
          <button type="button" class="btn btn-success btn-adicionar" data-bs-toggle="modal" data-bs-target="#AddProdut">
            ...
            <tr class="container">
              ...
              <div class="d-grid gap-2 d-md-block">
                <td class="d-flex justify-content-end colum-bottons-table">
                  ...
                  <button type="button" class="btn btn-primary bottom-options" data-bs-toggle="modal" data-bs-target="#EditarProd-<?= $produto->id ?>">
                    <img alt="Editar" src="../../public/assets/bx_bxs-edit.svg">
                  </button>

                  <!-- Button modal visualizar produto -->
                  <button type="button" class="btn btn-secondary bottom-options" data-bs-toggle="modal" data-bs-target="#VisualizarProd-<?= $produto->id ?>">
                    <img alt="Visualizar" src="../../public/assets/akar-icons_eye.svg">
                  </button>

                  <!-- Button modal exclui produto-->
                  <button type="button" class="btn btn-danger bottom-options" data-bs-toggle="modal" data-bs-target="#ExcluiProd-<?= $produto->id ?>">
        ...
        <div class="modal-body">
          ...
          <form action="produtos/create" method="post" class="row g-3">
            ...
            <div class="col-12">
              ...
              <textarea class="form-control" name="descricao" id="inputDescritionAddProdut" rows="3" placeholder="O que é, o que faz..."></textarea>
            </div>
            <div class="col-12">
              <label for="inputInfoAddProdut" class="form-label">Informações sobre o Produto</label>
              <textarea class="form-control" id="inputInfoAddProdut" rows="3" placeholder="Composição do produto, rendimento..." name="informacoes-uteis"></textarea>
            </div>
            <div class="col-12">
              <label for="inputImage1AddProdut" class="form-label">Imagem 1</label>
              <input type="text" name="imagem-1" class="form-control" id="inputImage1AddProdut" placeholder="Insira o nome da imagem 1 do produto">
            </div>
            <div class="col-12">
              <label for="inputImage2AddProdut" class="form-label">Imagem 2</label>
              <input type="text" class="form-control" id="inputImage2AddProdut" placeholder="Insira o nome da imagem 2 do produto" name="imagem-2">
            </div>
            <div class="col-12">
              <label for="inputImage3AddProdut" class="form-label">Imagem 3</label>
              <input type="text" class="form-control" id="inputImage3AddProdut" placeholder="Insira o nome da imagem 3 do produto" name="imagem-3">
            </div>
            <div class="col-md-4">
  ...
  <?php foreach ($produtos as $produto) : ?>
    <div class="modal fade" id="EditarProd-<?= $produto->id ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
          <div class="modal-header">
          ...
          <div class="modal-body">
            ...
            <form action="produtos/update" method="post" class="row g-3">
              ...
              <div class="col-12">
                ...
                <textarea class="form-control" name="descricao" id="inputDescritionProdut" rows="3"> <?= $produto->descricao ?></textarea>
              </div>
              <div class="col-12">
                <label for="inputInfoProdut" class="form-label">Informações sobre o Produto</label>
                <textarea class="form-control" id="inputInfoProdut" rows="3" placeholder="Composição do produto, rendimento..." name="informacoes-uteis"><?= $produto->informacoes_uteis ?></textarea>
              </div>
              <div class="col-12">
                <label for="inputImage1Produt" class="form-label">Imagem 1</label>
                <input type="text" class="form-control" name="imagem-1" id="inputImage1Produt" value="<?= $produto->imagem_1 ?>">
              </div>
              <div class="col-12">
                <label for="inputImage2Produt" class="form-label">Imagem 2</label>
                <input type="text" class="form-control" id="inputImage2Produt" placeholder="Insira o nome da imagem 2 do produto" value="<?= $produto->imagem_2 ?>" name="imagem-2">
              </div>
              <div class="col-12">
                <label for="inputImage3Produt" class="form-label">Imagem 3</label>
                <input type="text" class="form-control" id="inputImage3Produt" placeholder="Insira o nome da imagem 3 do produto" value="<?= $produto->imagem_3 ?>" name="imagem-3">
              </div>
              <div class="col-md-4">
  ...
  <?php foreach ($produtos as $produto) : ?>
    <div class="modal fade" id="VisualizarProd-<?= $produto->id ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <fieldset disabled>
              <form class="row g-3">
                ...
                <div class="col-12">
                  ...
                  <textarea class="form-control" id="VisDescritionProdut" rows="3" placeholder="<?= $produto->descricao ?>"></textarea>
                </div>
                <div class="col-12">
  ...
  <?php foreach ($produtos as $produto) : ?>
    <div class="modal fade" id="ExcluiProd-<?= $produto->id ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
